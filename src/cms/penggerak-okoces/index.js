...
const PenggerakOkoceTable = () => {
    ...
    const handleDelete = async () => {
        setLoading(true);
        try {
            await axios.delete(`http://localhost:3000/penggerak-okoces/${toBeDeletedId}`, {
                headers: {
    ...
    return (
        <>
                            ...
                            <React.Fragment key={item.id}>
                                ...
                                >
                                    <td className="py-3 px-4">
                                        <img
                                            src={`http://localhost:3000${item.fotoPenggerak}`}
                                        ...
                                        <td colSpan="5" className="py-4 px-6">
                                            <div className="flex justify-between">
                                                <div>
                                                    ...
                                                    <p><span className="font-semibold">Tanggal Publish:</span> {new Date(item.publishedAt).toLocaleString()}</p>
                                                </div>
                                                <button
            ...
            <ConfirmationModal
                show={modalShow}
                title="Hapus Penggerak"
                message="Apakah Anda yakin ingin menghapus Penggerak ini?"
