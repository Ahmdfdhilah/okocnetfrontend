...
const SosmedTable = () => {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get('https://okocenet-72f35a89c2ef.herokuapp.com/sosmeds', { params: query });
    ...
    const handleDelete = async (id) => {
        try {
            await axios.delete(`https://okocenet-72f35a89c2ef.herokuapp.com/sosmeds/${id}`, {
                headers: {
