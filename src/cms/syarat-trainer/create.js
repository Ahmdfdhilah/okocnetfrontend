...
const CreateSyaratTrainer = () => {
    ...
    const onSubmit = async (e) => {
        ...
        setModalAction(() => async () => {
            try {
                setLoading(true);
                await axios.post(`http://localhost:3000/syarat-trainers`, formData, {
                    headers: {
        ...
        setModalMessage('Apakah Anda yakin ingin membuat syarat trainer ini?');
        setModalShow(true);
    };
    ...
    return (
        <>
            ...
            <div className="container mx-auto py-10 mt-32">
                <h1 className="text-4xl font-bold mb-8 text-center">Create New Syarat Trainer</h1>
...
export default CreateSyaratTrainer;