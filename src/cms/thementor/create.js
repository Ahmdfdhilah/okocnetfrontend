...
const CreateThementor = () => {
    ...
    const validateForm = () => {
        ...
        if (formData.files.length === 0) {
            errors.dokumentasi = 'Dokumentasi harus diunggah';
            valid = false;
        }
    ...
    const onSubmit = async (e) => {
        ...
        setModalAction(() => async () => {
            try {
                ...
                await axios.post('http://localhost:3000/thementors', formDataToSend, {
                    headers: {
                ...
                console.error('Error creating Thementor:', error);
                setLoading(false);
            }
        });
        setModalTitle('Konfirmasi');
        setModalMessage('Apakah Anda yakin ingin membuat Thementor ini?');
        setModalShow(true);
    };
    ...
    return (
        <>
            ...
            <div className="container mx-auto py-10 mt-32">
                <h1 className="text-4xl font-bold mb-8 text-center">Create New Thementor</h1>
                <form onSubmit={onSubmit} className="max-w-2xl mx-auto p-6 bg-white rounded-lg shadow-md" encType="multipart/form-data">
                    ...
                    {/* Dokumentasi */}
                    <div className="mb-6">
                        <label htmlFor="dokumentasi" className="block text-lg font-medium text-gray-700 mb-2">
                            Dokumentasi
                        </label>
                        <input
                            type="file"
...
export default CreateThementor;