...
const CreateBenefitMasterMentor = () => {
    ...
    const onSubmit = async (e) => {
        ...
        setModalAction(() => async () => {
            try {
                ...
                await axios.post(`http://localhost:3000/benefit-master-mentors`, formDataToSend, {
                    headers: {
                ...
                navigate('/admin/benefit-master-mentors');
            } catch (error) {
        ...
        setModalMessage('Apakah Anda yakin ingin membuat benefit master mentor ini?');
        setModalShow(true);
    };
    ...
    return (
        <>
            ...
            <div className="container mx-auto py-10 mt-32">
                <h1 className="text-4xl font-bold mb-8 text-center">Create New Benefit Master Mentor</h1>
...
export default CreateBenefitMasterMentor;
