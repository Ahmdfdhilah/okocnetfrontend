...
const MitraTable = () => {
    ...
    const fetchData = async () => {
        setLoading(true);
        try {
            const response = await axios.get('http://localhost:3000/mitras', { params: query });
    ...
    const handleDelete = async () => {
        setLoading(true);
        try {
            await axios.delete(`http://localhost:3000/mitras/${toBeDeletedId}`, {
                headers: {
    ...
    const handleCreateNew = () => {
        navigate('/admin/mitra/create');
    };

    const handleEdit = (id) => {
        navigate(`/admin/mitra/edit/${id}`);
    };
        ...
        <>
            ...
            <div className="overflow-x-auto my-32 px-6">
                <div className="flex justify-between mb-6">
                    <h2 className="text-2xl font-semibold text-gray-800">Mitra</h2>
                    <button
            ...
            <ConfirmationModal
                show={modalShow}
                title="Delete Mitra"
                message="Are you sure you want to delete this Mitra?"
