...
const Thementor = () => {
  return (
    <>
      <div className="flex overflow-hidden relative flex-col p-20 text-center text-white min-h-[391px] max-md:px-5">
        <img
          loading="lazy"
          src={Header}
        ...
        <div className="relative mt-16 text-lg leading-7 max-md:mt-10 max-md:mr-1.5 max-md:max-w-full">
      ...
      {/* Gambar utama */}
      <div className="flex overflow-hidden relative flex-col items-center px-16 pt-20 pb-9 min-h-[715px] max-md:px-5 max-md:pt-10 max-md:pb-0 max-md:min-h-[210px]">
        <img
          loading="lazy"
          src={Themen}
      ...
      {/* Gambar Utama End */}
      {/* Teks content 1 */}
      <div className="px-7 pt-6 pb-4 text-lg leading-7 mr-2 ml-2 text-center text-black max-md:px-5 max-md:max-w-full">
      ...
      {/* Teks Content 2 */}
      <div className="justify-center px-9 py-5 mr-2 ml-2 text-lg leading-7 text-center text-black max-md:px-5 max-md:max-w-full">
      ...
      {/* Teks Content 3 */}
      <div className="justify-center px-3 py-5 mr-2 ml-2 text-lg leading-7 text-center text-black max-md:pr-5 max-md:max-w-full">
