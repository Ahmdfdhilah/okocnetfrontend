                    ...
                    <div class="grid grid-cols-3 sm:grid-cols-2 md:grid-cols-3 gap-8">
                        ...
                        {penggerak.map((penggerak) => (
                            <div class="bg-white rounded-lg border drop-shadow-xl p-4">
                                <img className="min-h-60 max-h-60 min-w-40 mx-auto" src={'https://cms-okoce-a155c649b6e6.herokuapp.com' + penggerak.attributes.foto_penggerak.data[0].attributes.url} alt={penggerak.attributes.nama_penggerak} />
                                <div class="px-1 py-4">
