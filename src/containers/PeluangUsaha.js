...
import Header from "../asset/img/headerPeluang.png";
            ...
            <div className="my-10 max-w-4xl mx-auto p-4">
                <div className="bg-white shadow-md rounded-lg">
                    <div className="p-5">
                        ...
                        <button onClick={toggleAccordion2} className={accordionButtonClasses}>
                            <span class="text-black">Detail Informasi</span>
                            <svg className={`w-6 h-6 transform transition-transform ${isAccordionOpen2 ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                            </svg>
                        </button>
                    </div>
            ...
            <div className="my-10 max-w-4xl mx-auto p-4">
                <div className="bg-white shadow-md rounded-lg">
                    <div className="p-5">
                        ...
                        <button onClick={toggleAccordion3} className={accordionButtonClasses}>
                            <span class="text-black">Detail Informasi</span>
                            <svg className={`w-6 h-6 transform transition-transform ${isAccordionOpen3 ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                            </svg>
                        </button>
                    </div>
