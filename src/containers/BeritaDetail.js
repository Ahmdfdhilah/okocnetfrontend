                ...
                <div className="max-w-4xl mx-auto mt-24 p-4">
                    <div className="bg-white shadow-md rounded-lg p-10">
                        <div className="w-[90%] mx-auto">
                            ...
                            <img className="mt-10 object-cover w-full h-full" src={`http://localhost:3000${newsData.fotoBerita}`} alt="news" />
                            <div className="w-full mt-14 mx-auto border-blue-400">
                                ...
                                <img className="mt-6 mb-10 object-cover w-full h-full" src={`http://localhost:3000${newsData.fotoContent}`} alt="content" />
                            </div>
                        </div>
                    </div>
                </div>
