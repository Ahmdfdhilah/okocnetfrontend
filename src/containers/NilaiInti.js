...
const NilaiInti = () => {
    return (
        <>
            <div className="w-full mobile:mt-24 lg:mt-28">
                <div className="mx-auto w-full h-full">
                    <img className="mobile:w-full mobile:h-full object-cover lg:mx-auto lg:w-[80%] lg:h-auto lg:rounded-xl" src={Header} alt="" />
                </div>
            </div>
