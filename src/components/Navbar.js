...
function Navbar() {
  ...
  const adminMenuItems = [
    ...
    { name: "Merchandise", link: "/admin/merchandise" },
  ...
  return (
    <>
      {role === 'admin' ? (
         ...
         <div className="fixed w-svw bg-white top-0 z-50 flex items-center justify-between mx-auto p-2 max-h-24 shadow-lg md:hidden">
           <a href="/" className="ml-4">
             <img src={LogoOkOce} className="h-20" alt="Ok Oce Logo" />
           </a>
           <button
             type="button"
             className="md:hidden inline-flex items-center mr-3 p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200"
           ...
           <div className={`absolute top-16 left-0 w-full bg-gray-50 md:hidden ${isAdminDropdownVisible ? "block" : "hidden"}`}>
               ...
               {adminMenuItems.map((item, index) => (
                 <li key={index}>
                   ...
                   <div className={`${activeAdminDropdown === index ? "" : "hidden"} pl-4`}>
                     <Link to={`${item.link}/create`} className="block py-1 px-3 text-black hover:bg-gray-200 rounded-lg">
                       Create
                     </Link>
                     <Link to={item.link} className="block py-1 px-3 text-black hover:bg-gray-200 rounded-lg">
                       View
                     </Link>
                   </div>
                 </li>
         ...
         <div className="fixed hidden w-full bg-white top-0 z-50 flex items-center justify-between mx-auto p-2 max-h-24 shadow-lg md:flex">
           <a href="/" className="ml-4">
             <img src={LogoOkOce} className="h-20" alt="Ok Oce Logo" />
           </a>
           <ul className="flex space-x-2">
             {adminMenuItems.map((adminMenuItem, index) => (
               <li key={index} className="relative group">
                 <Link to={adminMenuItem.link} className="uppercase py-2 px-3 text-black hover:bg-red-600 rounded-lg">
                   {adminMenuItem.name}
                 </Link>
                 <div className="absolute hidden group-hover:block bg-white border border-gray-200 rounded-lg shadow-lg mt-2">
                   <Link to={`${adminMenuItem.link}/create`} className="block py-2 px-4 text-black hover:bg-gray-200">
                     Create
                   </Link>
                   <Link to={adminMenuItem.link} className="block py-2 px-4 text-black hover:bg-gray-200">
                     View
                   </Link>
                 </div>
               </li>
           ...
           <div className="mr-16">
             <button
               className="text-white bg-red-600 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-base px-4 py-2 text-center"
               onClick={handleLogout}
             >
               Keluar
             </button>
